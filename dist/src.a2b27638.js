...
if (!(0, _cookie.getCookie)('sessionId')) {
  (0, _cookie.setCookie)('sessionId', (0, _uuid.v4)());
  var testVariation = Math.random() < 0.5;
  (0, _cookie.setCookie)('abTestVersion', testVariation ? 'test' : 'control');
}
var showVariation = false;
var cookieValue = (0, _cookie.getCookie)('abTestVersion');
if (cookieValue === 'test') {
  showVariation = true;
}
...
window.addEventListener('load', function () {
  setup();
  var uuid = (0, _cookie.getCookie)('sessionId');
  var variant = (0, _cookie.getCookie)('abTestVersion');
  var url = window.location.href;
  (0, _analyticsApi.trackPageview)(JSON.stringify({
    uuid: uuid,
    variant: variant,
    url: url
  }));
...
function setup() {
  ...
  link.addEventListener('click', function (event) {
    ...
    (0, _analyticsApi.trackEvent)(JSON.stringify({
      uuid: uuid,
      variant: variant,
      eventName: eventName,
      url: url
...
},{"./styles.css":"src/styles.css","uuid":"node_modules/uuid/dist/esm-browser/index.js","./analytics-api.js":"src/analytics-api.js","./cookie":"src/cookie.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
